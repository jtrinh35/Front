...
export const transactionCancel = async(authorized_amount, authorization_id) => {
    ...
    var config = {
    method: 'post',
    url: `https://directpayment.stg.eu.edenred.io/v2/transactions/${authorization_id}/actions/cancel`,
    headers: { 
