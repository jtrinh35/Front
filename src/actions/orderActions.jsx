import  {ORDER_CREATE_REQUEST,ORDER_CREATE_SUCCESS,ORDER_CREATE_FAIL, ORDER_DETAILS_REQUEST, ORDER_DETAILS_SUCCESS, ORDER_DETAILS_FAIL, ORDER_PAY_REQUEST, ORDER_PAY_FAIL, ORDER_PAY_SUCCESS, ORDER_COM_REQUEST, ORDER_COM_SUCCESS, ORDER_COM_FAIL, ORDER_VERIF_REQUEST, ORDER_VERIF_SUCCESS, ORDER_VERIF_FAIL} from '../constants/orderConstants'
...
export const detailsOrder = (orderId, axiosInstance) => async(dispatch, getState) => {  
    ...
    localStorage.setItem('orderDetails', JSON.stringify(getState().orderDetails));
}

export const payOrder = (order, email, paymentIntent, axiosInstance, order_amount) => async(dispatch) => {
...
export const comOrder = (orderId, com, axiosInstance) => async(dispatch) => {
    ...
    try{
        const {data} = await axiosInstance.put(`/orders/${orderId}/commentaire`, {commentaire: com});
